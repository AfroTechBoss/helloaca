...
import { Eye, EyeOff, FileText, Mail, Lock, User, Building, AlertCircle, Loader2, CheckCircle } from 'lucide-react'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await signUp(formData.email, formData.password, {
        ...
        subscribe_newsletter: formData.subscribeToNewsletter
      })
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Create your account to get started with contract analysis
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  />
                  <Label htmlFor="subscribeToNewsletter" className="text-sm leading-5">
